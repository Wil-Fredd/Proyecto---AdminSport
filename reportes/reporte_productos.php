...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(25, 10, utf8_decode('P-COMPRA'), 1, 0, 'C', 1);
      $this->Cell(25, 10, utf8_decode('P-VENTA'), 1, 0, 'C', 1);
      $this->Cell(25, 10, utf8_decode('EXISTENCIA'), 1, 0, 'C', 1);
      $this->Cell(35, 10, utf8_decode('PROVEEDOR'), 1, 1, 'C', 1);
   }
...
for($i=0;$i<count($data);$i++){
   ...
   $pdf->Cell(20,10,$data[$i]['codigo'],1,0);
   $pdf->Cell(40,10,$data[$i]['nombre'],1,0);
   $pdf->Cell(25,10,$data[$i]['pcompra'],1,0);
   $pdf->Cell(25,10,$data[$i]['pventa'],1,0);
   $pdf->Cell(25,10,$data[$i]['existencia'],1,0);
