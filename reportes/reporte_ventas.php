...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(24, 10, utf8_decode('FECHA'), 1, 0, 'C', 1);
      $this->Cell(25, 10, utf8_decode('USUARIO'), 1, 0, 'C', 1);
      $this->Cell(35, 10, utf8_decode('CLIENTE'), 1, 0, 'C', 1);
      $this->Cell(35, 10, utf8_decode('ZAPATO'), 1, 0, 'C', 1);
...
for($i=0;$i<count($data);$i++){
   ...
   $pdf->Cell(24,10,$data[$i]['fecha'],1,0);
   $pdf->Cell(25,10,$data[$i]['nombre_usu'],1,0);
   $pdf->Cell(35,10,$data[$i]['nombre_cliente'],1,0);
   $pdf->Cell(35,10,$data[$i]['nombre'],1,0);
   $pdf->Cell(20,10,$data[$i]['precio'],1,0);
   $pdf->Cell(20,10,$data[$i]['cantidad'],1,0);
   $pdf->Cell(20,10,$data[$i]['totalfactura'],1,1,'C');
