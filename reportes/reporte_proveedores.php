...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(30, 10, utf8_decode('PROVEEDOR'), 1, 0, 'C', 1);
      $this->Cell(40, 10, utf8_decode('CONTACTO'), 1, 0, 'C', 1);
...
for($i=0;$i<count($data);$i++){
   ...
   $pdf->Cell(20,10,$data[$i]['cod_proveedor'],1,0);
   $pdf->Cell(30,10,$data[$i]['proveedor'],1,0);
   $pdf->Cell(40,10,$data[$i]['contacto'],1,0);
   $pdf->Cell(35,10,$data[$i]['telefono'],1,0);
   $pdf->Cell(60,10,$data[$i]['direccion'],1,1, 'C');
...
$pdf->Output('Reporte_Proveedores.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
