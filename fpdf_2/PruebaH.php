...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(85, 10, utf8_decode(''),'C', );
      $this->Cell(40, 10, utf8_decode(''),'C', 1);
   }
   ...
   $resul = $conexion->prepare("SELECT * FROM productos");
   $resul->execute();
...
for($i=0;$i<count($data);$i++){
   ...
   $pdf->Cell(10,10,$i+1,1,0);
   $pdf->Cell(25,10,$data[$i]['codigo'],1,0);
   $pdf->Cell(50,10,$data[$i]['nombre'],1,0);
   $pdf->Cell(50,10,$data[$i]['pcompra'],1,0);
   $pdf->Cell(15,10,$data[$i]['pventa'],1,1,'C');
